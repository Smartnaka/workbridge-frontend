...
const Sidebar = ({ user, stats }) => {
  // Example stats structure if backend doesn't send color:
  // stats = [
  //   { title: "Applied", value: 12, color: "" },
  //   { title: "In Review", value: 5, color: "text-yellow-500" },
  //   { title: "Interviews", value: 2, color: "text-secondary" },
  //   { title: "Offers", value: 1, color: "text-green-500" },
  // ];
